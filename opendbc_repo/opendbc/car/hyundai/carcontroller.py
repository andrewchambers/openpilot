  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.CP.flags & HyundaiFlags.CANFD:
      ...
      if self.frame % 5 == 0 and (not hda2 or hda2_long):
        can_sends.append(hyundaicanfd.create_lfahda_cluster(self.packer, self.CAN, CS.out.cruiseState.available))
      ...
      can_sends.append(hyundaican.create_lkas11(self.packer, self.frame, self.CP, apply_steer, apply_steer_req,
                                                torque_fault, CS.lkas11, sys_warning, sys_state, CS.out.cruiseState.available,
      ...
      if self.frame % 2 == 0 and self.CP.openpilotLongitudinalControl:
        required_jerk = min(6, abs(accel - CS.out.aEgo) * 50)
      ...
      if self.frame % 5 == 0 and self.CP.flags & HyundaiFlags.SEND_LFA.value:
        can_sends.append(hyundaican.create_lfahda_mfc(self.packer, CS.out.cruiseState.available))
